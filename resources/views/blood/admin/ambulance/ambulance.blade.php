                            ...
                            @foreach($ambulances as $ambulance)
                                <tr class="ambulance-{{ $ambulance->id }}">
                                    ...
                                    <td style="vertical-align:middle;text-align:center;">
                                        <button class="btn btn-warning btn-sm" data-toggle="modal" id="editAmbulance" data-target="#editAmbulanceModal" data-id="{{ $ambulance->id }}" data-name="{{ $ambulance->name }}" data-driver_name="{{ $ambulance->driver_name }}" data-phone_number={{ $ambulance->phone_number }} da><i class="fas fa-pencil-alt"></i></button>
