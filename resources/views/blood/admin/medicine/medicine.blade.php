                        ...
                        <tbody id="allmedicine">
                            @foreach($medicines as $medicine)
                                <tr class="medicine-{{ $medicine->id }}">
                                    ...
                                    <td>{{ $medicine->dose }}</td>
                                    <td>{{ $medicine->status == 1 ? 'Show' : 'Hide' }}</td>
                                    <td style="vertical-align:middle;text-align:center;">
                                        <button class="btn btn-warning btn-sm" data-toggle="modal" id="editMedicine" data-target="#editMedicineModal" data-id="{{ $medicine->id }}"   data-symptom_id="{{ $medicine->symptom_id }}" data-dose="{{ $medicine->dose }}" data-status="{{ $medicine->status }}"><i class="fas fa-pencil-alt"></i></button>
